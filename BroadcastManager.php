...
use Voyager\Broadcasting\Broadcasters\LogBroadcaster;
...
use Voyager\Contracts\Broadcasting\ShouldRescue;
...
class BroadcastManager implements FactoryContract
{
    ...
    // Laravel registers HTTP routes for channel authentication here
    // (routes, userRoutes, channelRoutes) and reads the socket id off the
    // incoming request. All of that is receiving-HTTP, so it is cut.
    ...
    // Ably is dropped by the driver policy; Pusher is the supported
    // hosted broadcaster.
